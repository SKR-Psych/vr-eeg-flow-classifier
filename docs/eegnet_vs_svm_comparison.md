# EEGNet vs. Legacy SVM: Performance Benchmarking & Architectural Comparison

**Project:** VR-EEG Flow State Classifier  
**Dataset:** OpenNeuro `ds003846` (64-Channel actiCAP EEG, VR Reach-to-Touch)  
**Document Status:** Formal Validation & Upgrade Report  

---

## 1. Executive Summary

This document captures the comparative evaluation between the **Legacy Baseline Classifiers** (Support Vector Machines [SVM] & Random Forest with continuous 2.0s sliding-window features) and the upgraded **EEGNet Deep Learning Architecture** (event-locked spatio-temporal convolutions).
...
Data sourced from [`data/ds003846/derivatives/eegnet_vs_svm_comparison.csv`](file:///c:/Users/Sami/Desktop/Uni/vr-eeg-flow-classifier/data/ds003846/derivatives/eegnet_vs_svm_comparison.csv):
